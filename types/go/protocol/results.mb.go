...
const (
	...
	TRANSACTION_STATUS_PRE_ORDER_VALID TransactionStatus = 4
	TRANSACTION_STATUS_NO_RECORD_FOUND TransactionStatus = 5
	TRANSACTION_STATUS_REJECTED_UNSUPPORTED_VERSION TransactionStatus = 6
	TRANSACTION_STATUS_REJECTED_VIRTUAL_CHAIN_MISMATCH TransactionStatus = 7
	TRANSACTION_STATUS_REJECTED_TIMESTAMP_WINDOW_EXCEEDED TransactionStatus = 8
	TRANSACTION_STATUS_REJECTED_SIGNATURE_MISMATCH TransactionStatus = 9
	TRANSACTION_STATUS_REJECTED_UNKNOWN_SIGNER_SCHEME TransactionStatus = 10
	TRANSACTION_STATUS_REJECTED_VIRTUAL_CHAIN_SUBSCRIPTION TransactionStatus = 11
	TRANSACTION_STATUS_REJECTED_VIRTUAL_CHAIN_PRE_ORDER TransactionStatus = 12
	TRANSACTION_STATUS_REJECTED_SMART_CONTRACT_PRE_ORDER TransactionStatus = 13
	TRANSACTION_STATUS_REJECTED_DUPLCIATE_PENDING_TRANSACTION TransactionStatus = 14
	TRANSACTION_STATUS_REJECTED_TIMESTAMP_PRECEDES_NODE_TIME TransactionStatus = 15

...
const (
	...
	EXECUTION_RESULT_ERROR_SYSTEM                ExecutionResult = 5
)
...
func (n ExecutionResult) String() string {
	...
	case EXECUTION_RESULT_ERROR_SYSTEM:
		return "EXECUTION_RESULT_ERROR_SYSTEM"
	}
	return "UNKNOWN"
}
...
const (
	...
	REQUEST_STATUS_REJECTED     RequestStatus = 3

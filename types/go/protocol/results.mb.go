...
const (
	...
	TRANSACTION_STATUS_REJECTED_TIMESTAMP_PRECEDES_NODE_TIME TransactionStatus = 26
)
...
func (n TransactionStatus) String() string {
	...
	case TRANSACTION_STATUS_REJECTED_TIME_STAMP_WINDOW_EXCEEDED:
		return "TRANSACTION_STATUS_REJECTED_TIME_STAMP_WINDOW_EXCEEDED"

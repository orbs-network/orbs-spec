...
const (
	...
	HANDLE_BLOCK_CONSENSUS_MODE_SOFT_VERIFY_ONLY  HandleBlockConsensusMode = 4
)
...
func (n HandleBlockConsensusMode) String() string {
	...
	case HANDLE_BLOCK_CONSENSUS_MODE_SOFT_VERIFY_ONLY:
		return "HANDLE_BLOCK_CONSENSUS_MODE_SOFT_VERIFY_ONLY"
	}
	return "UNKNOWN"
}
